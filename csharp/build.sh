...
${nuget_cmd} install src/BungieNetApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BungieNetApi.dll"
...
then
  ...
  echo "[INFO] bin/BungieNetApi.dll was created successfully"
fi
