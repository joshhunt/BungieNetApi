...
namespace BungieNetApi.Api
{
    ...
    public partial class AppApi : IAppApi
    {
        ...
        /// <returns></returns>
        public AppApi(BungieNetApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="start">Start time for query. Goes to 24 hours ago if not specified. (optional)</param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        public ApiResponse<InlineResponse200> AppGetApplicationApiUsageWithHttpInfo (int applicationId, DateTime end = default(DateTime), DateTime start = default(DateTime))
        {
        ...
        /// <param name="start">Start time for query. Goes to 24 hours ago if not specified. (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse200)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> AppGetApplicationApiUsageAsyncWithHttpInfo (int applicationId, DateTime end = default(DateTime), DateTime start = default(DateTime))
        {
            // verify the required parameter 'applicationId' is set
            if (applicationId == null)
                throw new ApiException(400, "Missing required parameter 'applicationId' when calling AppApi->AppGetApplicationApiUsage");
