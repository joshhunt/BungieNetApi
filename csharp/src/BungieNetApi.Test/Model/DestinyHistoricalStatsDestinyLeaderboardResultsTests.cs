...
namespace BungieNetApi.Test
{
    ...
    public class DestinyHistoricalStatsDestinyLeaderboardResultsTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" DestinyHistoricalStatsDestinyLeaderboardResults
            //Assert.IsInstanceOf(typeof(DestinyHistoricalStatsDestinyLeaderboardResults), instance);
        }
