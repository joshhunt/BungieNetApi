...
namespace BungieNetApi.Test
{
    ...
    public class ContentModelsContentTypePropertyTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" ContentModelsContentTypeProperty
            //Assert.IsInstanceOfType<ContentModelsContentTypeProperty> (instance, "variable 'instance' is a ContentModelsContentTypeProperty");
        }
