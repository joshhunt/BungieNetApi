...
namespace BungieNetApi.Model {
  ...
  /// </summary>
  [DataContract]
  public class DestinyDefinitionsMilestonesDestinyMilestoneDisplayPreference {
    ...
    public override string ToString()  {
      ...
      sb.Append("class DestinyDefinitionsMilestonesDestinyMilestoneDisplayPreference {\n");
      sb.Append("}\n");
      return sb.ToString();
    }
