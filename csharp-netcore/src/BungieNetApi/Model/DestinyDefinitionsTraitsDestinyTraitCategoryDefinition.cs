...
namespace BungieNetApi.Model
{
    ...
    public partial class DestinyDefinitionsTraitsDestinyTraitCategoryDefinition :  IEquatable<DestinyDefinitionsTraitsDestinyTraitCategoryDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsTraitsDestinyTraitCategoryDefinition(string traitCategoryId = default(string), List<int> traitHashes = default(List<int>), List<string> traitIds = default(List<string>), int hash = default(int), int index = default(int), bool redacted = default(bool))
        {
