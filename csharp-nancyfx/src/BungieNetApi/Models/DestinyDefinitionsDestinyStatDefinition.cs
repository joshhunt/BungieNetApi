...
namespace BungieNetApi._Platform.Models
{
    ...
    /// </summary>
    public sealed class DestinyDefinitionsDestinyStatDefinition:  IEquatable<DestinyDefinitionsDestinyStatDefinition>
    { 
        /// <summary>
        /// DisplayProperties
        /// </summary>
        ...
        /// </summary>
        public int? AggregationType { get; private set; }
        ...
        /// </summary>
        public bool? HasComputedBlock { get; private set; }

        /// <summary>
        /// The category of the stat, according to the game.
        /// </summary>
        public int? StatCategory { get; private set; }
        ...
        /// Use DestinyDefinitionsDestinyStatDefinition.Builder() for instance creation instead.
        /// </summary>
        [Obsolete]
        ...
        private DestinyDefinitionsDestinyStatDefinition(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition DisplayProperties, int? AggregationType, bool? HasComputedBlock, int? StatCategory, int? Hash, int? Index, bool? Redacted)
        {
        ...
        /// <summary>
        /// Returns builder of DestinyDefinitionsDestinyStatDefinition.
        /// </summary>
        /// <returns>DestinyDefinitionsDestinyStatDefinitionBuilder</returns>
        public static DestinyDefinitionsDestinyStatDefinitionBuilder Builder()
        {
            return new DestinyDefinitionsDestinyStatDefinitionBuilder();
        }

        /// <summary>
        /// Returns DestinyDefinitionsDestinyStatDefinitionBuilder with properties set.
        /// Use it to change properties.
        /// </summary>
        /// <returns>DestinyDefinitionsDestinyStatDefinitionBuilder</returns>
        public DestinyDefinitionsDestinyStatDefinitionBuilder With()
        {
            return Builder()
        ...
        public bool Equals(DestinyDefinitionsDestinyStatDefinition other)
        {
        ...
        /// <summary>
        /// Implementation of == operator for (DestinyDefinitionsDestinyStatDefinition.
        /// </summary>
        /// <param name="left">Compared (DestinyDefinitionsDestinyStatDefinition</param>
        /// <param name="right">Compared (DestinyDefinitionsDestinyStatDefinition</param>
        /// <returns>true if compared items are equals, false otherwise</returns>
        public static bool operator == (DestinyDefinitionsDestinyStatDefinition left, DestinyDefinitionsDestinyStatDefinition right)
        {
        ...
        /// <summary>
        /// Builder of DestinyDefinitionsDestinyStatDefinition.
        /// </summary>
        public sealed class DestinyDefinitionsDestinyStatDefinitionBuilder
        {
            private DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition _DisplayProperties;
            private int? _AggregationType;
            private bool? _HasComputedBlock;
            private int? _StatCategory;
            private int? _Hash;
            private int? _Index;
            private bool? _Redacted;

            internal DestinyDefinitionsDestinyStatDefinitionBuilder()
            {
                SetupDefaults();
            }
            ...
            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.DisplayProperties property.
            /// </summary>
            /// <param name="value">DisplayProperties</param>
            public DestinyDefinitionsDestinyStatDefinitionBuilder DisplayProperties(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition value)
            {
            ...
            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.AggregationType property.
            /// </summary>
            /// <param name="value">Stats can exist on a character or an item, and they may potentially be aggregated in different ways. The DestinyStatAggregationType enum value indicates the way that this stat is being aggregated.</param>
            public DestinyDefinitionsDestinyStatDefinitionBuilder AggregationType(int? value)
            {
            ...
            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.HasComputedBlock property.
            /// </summary>
            /// <param name="value">True if the stat is computed rather than being delivered as a raw value on items.  For instance, the Light stat in Destiny 1 was a computed stat.</param>
            public DestinyDefinitionsDestinyStatDefinitionBuilder HasComputedBlock(bool? value)
            {
                _HasComputedBlock = value;
                return this;
            }

            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.StatCategory property.
            /// </summary>
            /// <param name="value">The category of the stat, according to the game.</param>
            public DestinyDefinitionsDestinyStatDefinitionBuilder StatCategory(int? value)
            {
                _StatCategory = value;
                return this;
            }
            ...
            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.Hash property.
            /// </summary>
            ...
            public DestinyDefinitionsDestinyStatDefinitionBuilder Hash(int? value)
            {
                _Hash = value;
                return this;
            }
            ...
            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.Index property.
            /// </summary>
            /// <param name="value">The index of the entity as it was found in the investment tables.</param>
            public DestinyDefinitionsDestinyStatDefinitionBuilder Index(int? value)
            {
                _Index = value;
                return this;
            }
            ...
            /// <summary>
            /// Sets value for DestinyDefinitionsDestinyStatDefinition.Redacted property.
            /// </summary>
            ...
            public DestinyDefinitionsDestinyStatDefinitionBuilder Redacted(bool? value)
            {
                _Redacted = value;
                return this;
            }
            ...
            /// <summary>
            /// Builds instance of DestinyDefinitionsDestinyStatDefinition.
            /// </summary>
            /// <returns>DestinyDefinitionsDestinyStatDefinition</returns>
            public DestinyDefinitionsDestinyStatDefinition Build()
            {
                Validate();
                return new DestinyDefinitionsDestinyStatDefinition(
                    DisplayProperties: _DisplayProperties,
                    AggregationType: _AggregationType,
                    HasComputedBlock: _HasComputedBlock,
